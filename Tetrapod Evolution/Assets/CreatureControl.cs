...
public class CreatureControl : MonoBehaviour
{
    ...
    void Update()
    {
        Debug.Log("Pod 1 " + Input.GetAxis("Pod 1 Hip") + " " + Input.GetAxis("Pod 1 Arm") + " " + Input.GetAxis("Pod 1 Leg"));
        Debug.Log("Pod 2 " + Input.GetAxis("Pod 2 Hip") + " " + Input.GetAxis("Pod 2 Arm") + " " + Input.GetAxis("Pod 2 Leg"));
        Debug.Log("Pod 3 " + Input.GetAxis("Pod 3 Hip") + " " + Input.GetAxis("Pod 3 Arm") + " " + Input.GetAxis("Pod 3 Leg"));
        Debug.Log("Pod 4 " + Input.GetAxis("Pod 4 Hip") + " " + Input.GetAxis("Pod 4 Arm") + " " + Input.GetAxis("Pod 4 Leg"));
